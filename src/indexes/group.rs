...
///
/// ```
/// # use merkledb::{access::{CopyAccessExt, FromAccess}, Database, Group, ListIndex, TemporaryDB};
/// let db = TemporaryDB::new();
/// let fork = db.fork();
...
///
/// ```
/// # use merkledb::{access::CopyAccessExt, Database, Group, ListIndex, TemporaryDB};
/// # let db = TemporaryDB::new();
/// # let fork = db.fork();
