...
///
/// ```
/// # use merkledb::{access::CopyAccessExt, Database, TemporaryDB};
...
///
/// ```rust,should_panic
/// # use merkledb::{access::CopyAccessExt, TemporaryDB, ListIndex, Database};
/// let db = TemporaryDB::new();
/// let fork = db.fork();
...
///
/// ```
/// # use merkledb::{Database, TemporaryDB};
/// let db = TemporaryDB::new();
...
pub trait DatabaseExt: Database {
    ...
    ///
    /// ```
    /// # use merkledb::{access::{Access, CopyAccessExt}, Database, DatabaseExt, TemporaryDB};
    /// let db = TemporaryDB::new();
    /// let fork = db.fork();
...
///
/// ```
/// # use merkledb::{access::CopyAccessExt, Database, ReadonlyFork, TemporaryDB};
/// let db = TemporaryDB::new();
/// let fork = db.fork();
/// fork.get_list("list").push(1_u32);
...
///
/// ```
/// # use merkledb::{access::AccessExt, AsReadonly, Database, OwnedReadonlyFork, TemporaryDB};
/// # use std::rc::Rc;
/// let db = TemporaryDB::new();
